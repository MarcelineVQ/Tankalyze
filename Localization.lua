...
L:RegisterTranslations("enUS", function() return {
	...
	["ResistJudgementRX"] = "Your Judgement of Justice was resisted by (.+)",
	["ImmuneJudgementRX1"] = "(.+) is immune to your Judgement of Justice%.",
	["ImmuneJudgementRX2"] = "Your Judgement of Justice failed%. (.+) is immune%.",
	["MissJudgementRX"] = "Your Judgement missed (.+)", -- can't happen?
	["TauntRX"] = "(.*)Taunt(.*)",
	...
	["JudgementMessage"] = ">>> Judgement {r} against: {t} ({l}) <<<",
	["JudgementMessageSCT"] = "Judgement {r}: {t}",
	["level "] = true,
	...
	["Announces resisted Judgement of Justice"] = true,
	["Mocking Blow"] = true,
